...
class FrankaCubeStackIKRelVisuomotorMimicEnvCfg(FrankaCubeStackVisuomotorEnvCfg, MimicEnvCfg):
    ...
    def __post_init__(self):
        ...
        # then grasp green (cube_3), implicit final stack on red (cube_2). ACTIVE.
        subtask_configs = []
        ...
        # then grasp red (cube_2), implicit final stack on green (cube_3). Left here
        # (inactive) for reference - do not delete, just keep commented out unless working
        # on the OOD variant again.
        # subtask_configs = []
        # subtask_configs.append(
        #     SubTaskConfig(
        #         # Each subtask involves manipulation with respect to a single object frame.
