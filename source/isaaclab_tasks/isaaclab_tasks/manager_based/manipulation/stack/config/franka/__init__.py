...
# added! Yuna - Rel-Visuomotor with a blue cylinder distractor (blue_cylinder)
gym.register(
    id="Isaac-Stack-Cube-BlueCylinder-Franka-IK-Rel-Visuomotor-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.stack_ik_rel_visuomotor_blue_cylinder_env_cfg:FrankaCubeStackVisuomotorBlueCylinderEnvCfg"
        ),
        "robomimic_bc_cfg_entry_point": f"{agents.__name__}:robomimic/bc_rnn_image_200.json",
    },
    disable_env_checker=True,
